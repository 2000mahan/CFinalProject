...
struct node *create_node(char issue[200], char decision1[200], int people_decision1, int darbar_decision1, int khazaneh_decision1
char decision2[200], int people_decision2, int darbar_decision2, int khazaneh_decision2)
{
struct node *nn;
